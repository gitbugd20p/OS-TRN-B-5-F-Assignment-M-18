    ...
    return (
        <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col gap-4 hover:shadow-xl transition duration-300">
            ...
            <div className="flex flex-col gap-2">
                <h3 className="text-xl font-semibold text-gray-900">{title.toUpperCase()}</h3>
            ...
            <div className="grid grid-cols-4 grid-rows-3 gap-2">
                {/* First Image (takes 2 cols, 1 row) */}
                ...
                {/* Second Image (takes 1 col, 1 row) */}
                ...
                {/* Third Image (takes 1 col, 2 rows) */}
                ...
                {/* Fourth Image (takes 1 col, 2 rows) */}
                <div className="col-span-2 row-span-2 rounded-xl overflow-hidden">
                    <img
                        src={images[3]}
                        alt="service-img-4"
